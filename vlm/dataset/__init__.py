...
from .image_mcq import ImageMCQDataset, CustomMCQDataset, MMERealWorld
...
DATASET_CLASSES = IMAGE_DATASET + CUSTOM_DATASET + DATASET_COLLECTION
SUPPORTED_DATASETS = []
...
__all__ = [
    'build_dataset', 'build_judge', 'extract_answer_from_item', 'prefetch_answer', 'DEBUG_MESSAGE'
